...
const Sidebar = () => {
 ...
 <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   ...
   <input type="checkbox" value="" className="sr-only peer" onChange={()=> setMode(!mode)}/>
   ...
   <span className="flex-1 ms-3  text-gray-900 dark:text-white  whitespace-nowrap">Mode</span>
 </label>
          </li>
       </ul>
       <MonthCalendar/>
